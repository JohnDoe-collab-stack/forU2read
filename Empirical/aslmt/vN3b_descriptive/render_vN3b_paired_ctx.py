...
def main() -> None:
    p = argparse.ArgumentParser(description="Render deterministic paired ctx witnesses for ASLMT vN3b.")
    ...
    out_dir = Path(args.out_dir).expanduser().resolve() if args.out_dir else (runs_dir / f"aslmt_vN3b_paired_ctx_{suf}")
