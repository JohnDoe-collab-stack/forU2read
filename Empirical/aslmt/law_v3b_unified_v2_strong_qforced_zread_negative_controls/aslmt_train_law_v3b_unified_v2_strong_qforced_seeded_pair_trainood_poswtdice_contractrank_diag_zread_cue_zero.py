...
from aslmt_env_law_v3b_unified_v2_strong_qforced_nscalable_spaced2_64_cue_zero import (
...
from render_law_v3b_unified_v2_strong_qforced_paired_ctx_nscalable_spaced2_64_cue_zero import Ctx, POS_STRIDE, render
...
def main() -> None:
    ...
    out = {
        "kind": "aslmt_law_v3b_unified_v2_strong_qforced_zread_negctrl_cue_zero_poswtdice_contractrank_spaced2_64",
        "seed": int(cfg.seed),
        "n_classes": int(n_classes),
