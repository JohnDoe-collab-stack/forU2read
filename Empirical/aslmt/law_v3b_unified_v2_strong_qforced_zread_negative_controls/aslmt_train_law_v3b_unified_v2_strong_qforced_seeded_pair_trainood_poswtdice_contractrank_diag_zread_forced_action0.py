...
from aslmt_model_law_v3b_unified_v2_strong_qforced_query_zread_forced_action0 import (
...
def main() -> None:
    ...
    out = {
        "kind": "aslmt_law_v3b_unified_v2_strong_qforced_zread_negctrl_forced_action0_poswtdice_contractrank_spaced2_64",
        "seed": int(cfg.seed),
        "n_classes": int(n_classes),
