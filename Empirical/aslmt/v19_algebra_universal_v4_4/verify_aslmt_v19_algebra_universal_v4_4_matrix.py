...
def main() -> None:
    p = argparse.ArgumentParser(description="Strict verifier for ASLMT v19 algebra universal v4.4 matrix runs.")
    ...
    expected_kind = "aslmt_v19_algebra_universal_actionz_v4_4"
    ...
    if failures:
        print("\n[FAIL] v19 algebra universal v4.4 checks did not pass:")
        for s in failures:
            print("-", s)
        raise SystemExit(1)

    print("\n[OK] v19 algebra universal v4.4 checks passed.")
