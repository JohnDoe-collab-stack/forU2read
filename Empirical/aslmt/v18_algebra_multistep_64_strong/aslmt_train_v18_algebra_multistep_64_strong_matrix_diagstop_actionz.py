...
from aslmt_env_v18_algebra_multistep_64_strong import V18AlgebraMultistepDataset64_Strong
from aslmt_model_v18_algebra_multistep_64_strong_actionz import V18AlgebraMultistepModelA_ActionZ_Strong
...
def main() -> None:
    ...
    for step in range(1, steps + 1):
        ...
        for t in range(q_steps):
            ...
            tgt = opt_actions[:, int(t)].to(torch.long)
    ...
    rec = {
        "kind": "aslmt_v18_algebra_multistep_64_strong_actionz",
        "seed": int(seed),
        "n_states": int(n_states),
        "n_views": int(n_views),
        "y_classes": int(y_classes),
