...
def main() -> None:
    ...
    tag = f"aslmt_v18_algebra_multistep_64_strong_actionz_{profile}_{ts}_{bundle_hash[:12]}"
    ...
    manifest = {
        "kind": "aslmt_v18_algebra_multistep_64_strong_snapshot",
        "timestamp": ts,
        "profile": str(profile),
    ...
    master_jsonl = run_dir / f"v18_algebra_multistep_64_strong_actionz_{profile}_master_{ts}_{bundle_hash[:12]}.jsonl"
