# ASLMT v19 — Algebra Universal v4.5 (learned encoder policy, strict protocol)

v4.5 builds on v4.4 and adds **belief–candidate consistency** (internalized closure).
...
This folder is a new protocol variant (v4.5). It does **not** modify v1/v2/v3/v4.1/v4.3/v4.4 scripts or historical run snapshots.
...
v19_algebra_universal_v4_5/aslmt_campaign_v19_algebra_universal_v4_5_matrix_diagstop_actionz.py \
...
run_dir="$(ls -1dt aslmt_v19_algebra_universal_actionz_v4_5_solid_* | head -n 1)"
...
```bash
/home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
/mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/v19_algebra_universal_v4_5/audit_v19_algebra_universal_v4_5_algebra.py \
