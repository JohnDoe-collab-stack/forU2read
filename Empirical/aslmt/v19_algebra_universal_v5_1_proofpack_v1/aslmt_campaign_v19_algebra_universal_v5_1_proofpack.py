...
def main() -> None:
    p = argparse.ArgumentParser(description="v19 universal v5.1 proof pack: train→ckpt→structural verify (IID+OOD).")
    ...
    run_dir = RUNS_DIR / f"aslmt_v19_algebra_universal_proofpack_v5_1_{ts}_{bundle_short}"
    run_dir.mkdir(parents=True, exist_ok=False)
    snap_root = SNAP_DIR / f"aslmt_v19_algebra_universal_proofpack_v5_1_{ts}_{bundle_short}"
