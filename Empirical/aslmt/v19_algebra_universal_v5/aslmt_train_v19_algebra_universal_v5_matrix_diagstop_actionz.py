...
from aslmt_env_v19_algebra_universal_v5 import V19AlgebraUniversalDataset
from aslmt_model_v19_algebra_universal_v5_actionz import (
    V19AlgebraCueOnlyBaseline,
    V19AlgebraUniversalModelA_ActionZ,
    V19AlgebraVisibleOnlyBaseline,
)
from aslmt_oracle_v19_algebra_universal_v5_common import (
    HorizonOracleCfg,
    candidate_mask,
...
def main() -> None:
    p = argparse.ArgumentParser(
        description="ASLMT v19 algebra universal v5 trainer (compatibility-aware belief + closed-only readout loss + stable eval logging)."
    )
    ...
    rec = {
        "kind": "aslmt_v19_algebra_universal_actionz_v5",
        "seed": int(args.seed),
        "n_states": int(n_states),
        "n_views": int(n_views),
        "y_classes": int(y_classes),
