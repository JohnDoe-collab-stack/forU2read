# ASLMT v19 — Algebra Universal v5 (learned encoder policy, strict protocol)

v5 builds on v4.9 and keeps the same compatibility-aware belief update, but improves **measurement**
by adding a stable periodic evaluation during training logs (so log metrics match verifier-style averages).
...
This folder is a new protocol variant (v5). It does **not** modify v1/v2/v3/v4.1/v4.3/v4.4/v4.5/v4.6/v4.7/v4.8/v4.9 scripts or historical run snapshots.
...
v19_algebra_universal_v5/aslmt_campaign_v19_algebra_universal_v5_matrix_diagstop_actionz.py \
...
run_dir="$(ls -1dt aslmt_v19_algebra_universal_actionz_v5_solid_* | head -n 1)"
...
```bash
/home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
/mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/v19_algebra_universal_v5/audit_v19_algebra_universal_v5_algebra.py \
