...
from aslmt_env_v17_symbolic_orbit_nscalable_64 import V17SymbolicOrbitDatasetNScalable64
from aslmt_model_v9_unified_double_barrier_minlift_kdet import V9CueOnlyBaseline, V9ImageOnlyBaseline, V9MinLiftModelA
from render_v17_symbolic_orbit_paired_ctx_64 import Ctx, POS_STRIDE, render, sample_ctx
...
def main() -> None:
    ...
    ds_iid = V17SymbolicOrbitDatasetNScalable64(size=50_000, n_classes=int(n_classes), ood=False, img_size=int(cfg.img_size), seed=int(cfg.seed))
    ds_ood = V17SymbolicOrbitDatasetNScalable64(
    ...
    def _eval_split(*, ood: bool) -> dict:
        ds = V17SymbolicOrbitDatasetNScalable64(
    ...
    out = {
        "kind": "aslmt_v17_symbolic_orbit_poswtdice_contractrank_64",
        "seed": int(cfg.seed),
        "n_classes": int(n_classes),
    ...
    if str(args.out_faildump_jsonl).strip():
        ...
        if need_dump:
            ...
            rec = {
                        "kind": "aslmt_v17_symbolic_orbit_faildump_image_gate",
                "seed": int(cfg.seed),
                "n_classes": int(n_classes),
                "z_classes": int(z_classes),
