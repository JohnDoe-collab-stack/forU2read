...
- `algebra_kernel` : **noyau exact (universel sur toute instance finie encodable)** : calcul déterministe de
  `R_σ`, `L_σ(E)`, `L_res`, `ρ_σ`, `Δ`, sélection greedy.
  Objectif : fournir une capacité “apply anywhere” au niveau algébrique, indépendante de l’entraînement.
