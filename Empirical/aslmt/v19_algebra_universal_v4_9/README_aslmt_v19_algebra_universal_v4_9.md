# ASLMT v19 — Algebra Universal v4.9 (learned encoder policy, strict protocol)

v4.9 builds on v4.8 and makes the belief update more transcript-faithful by adding a learned
...
This folder is a new protocol variant (v4.9). It does **not** modify v1/v2/v3/v4.1/v4.3/v4.4/v4.5/v4.6/v4.7/v4.8 scripts or historical run snapshots.
...
v19_algebra_universal_v4_9/aslmt_campaign_v19_algebra_universal_v4_9_matrix_diagstop_actionz.py \
...
run_dir="$(ls -1dt aslmt_v19_algebra_universal_actionz_v4_9_solid_* | head -n 1)"
...
```bash
/home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
/mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/v19_algebra_universal_v4_9/audit_v19_algebra_universal_v4_9_algebra.py \
