...
def _run_train(
    *,
    ...
    train_script = snapshot_dir / "aslmt_train_v9_unified_double_barrier_minlift_seeded_pair_trainood_v2.py"
...
def main() -> None:
    ...
    src_files = [
        ...
        (Path(__file__).parent / "aslmt_model_v9_unified_double_barrier_minlift_v2.py").resolve(),
        (Path(__file__).parent / "aslmt_train_v9_unified_double_barrier_minlift_seeded_pair_trainood_v2.py").resolve(),
    ...
    run_dir = RUNS_DIR / f"aslmt_v9_unified_v2_minlift_{ts}_{bundle_hash[:12]}"
    run_dir.mkdir(parents=True, exist_ok=False)
    master_jsonl = run_dir / f"v9_v2_master_{ts}_{bundle_hash[:12]}.jsonl"
