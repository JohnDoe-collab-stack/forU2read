...
from aslmt_env_v9_unified_double_barrier_minlift_nscalable_spaced2 import V9UnifiedDoubleBarrierMinLiftDatasetNScalableSpaced2
...
def _min_occ_half_for_n(*, n_classes: int, ood: bool) -> int:
    # mirror the env/renderer constraints
    n = int(n_classes)
...
def _make_dataloaders(*, batch_size: int, steps: int, train_ood_ratio: float, n_classes: int, seed: int) -> tuple[DataLoader, DataLoader, DataLoader]:
    ...
    iid_ds = V9UnifiedDoubleBarrierMinLiftDatasetNScalableSpaced2(size=1024, n_classes=n_classes, ood=False, seed=seed + 10_000)
    ood_ds = V9UnifiedDoubleBarrierMinLiftDatasetNScalableSpaced2(size=1024, n_classes=n_classes, ood=True, seed=seed + 20_000)
    train_iid = V9UnifiedDoubleBarrierMinLiftDatasetNScalableSpaced2(size=n_iid, n_classes=n_classes, ood=False, seed=seed + 30_000)
    train_ood = V9UnifiedDoubleBarrierMinLiftDatasetNScalableSpaced2(size=n_ood, n_classes=n_classes, ood=True, seed=seed + 40_000)
...
def main() -> None:
    ...
    for s in range(steps):
        ...
        rank_ood = (random.random() < rank_ood_ratio)
    ...
    payload = {
        "kind": "aslmt_v9_unified_double_barrier_minlift_posloss_pairrank_spaced2",
        "seed": int(args.seed),
        "n_classes": int(args.n_classes),
