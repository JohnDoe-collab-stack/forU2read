    ...
    *,
    ...
    with open(cert_jsonl, "r", encoding="utf-8") as f:
        for line in f:
            ...
            # P4 (monotone contraction: ambiguity must not increase)
...
def main() -> None:
    ...
    if str(args.out_report_json):
        Path(args.out_report_json).write_text(json.dumps(report, indent=2, sort_keys=True) + "\n", encoding="utf-8")
