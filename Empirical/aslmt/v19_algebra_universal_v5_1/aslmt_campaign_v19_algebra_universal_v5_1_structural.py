...
def main() -> None:
    p = argparse.ArgumentParser(description="Snapshot+run structural certificate+verifier for v5.1.")
    ...
    run_dir = RUNS_DIR / f"aslmt_v19_algebra_universal_struct_v5_1_{ts}_{bundle_short}"
    run_dir.mkdir(parents=True, exist_ok=False)
    snap_root = SNAP_DIR / f"aslmt_v19_algebra_universal_struct_v5_1_{ts}_{bundle_short}"
