...
from aslmt_oracle_v19_algebra_universal_v5_1_common import candidate_mask, sigma_ambiguity
...
def main() -> None:
    p = argparse.ArgumentParser(description="Independent algebra audit for v19 universal v5.1 episodes.")
