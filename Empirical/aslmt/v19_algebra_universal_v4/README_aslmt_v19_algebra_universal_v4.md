# ASLMT v19 — Algebra Universal v4 (learned encoder policy, strict protocol)

v4 builds on v3 and removes remaining hand-engineered policy features.
...
## Smoke (end-to-end)
  ...
  v19_algebra_universal_v4/aslmt_campaign_v19_algebra_universal_v4_matrix_diagstop_actionz.py \
...
snap_dir="/mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/runs/snapshots/<RUN_TAG>"
  /home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
  "$snap_dir/verify_aslmt_v19_algebra_universal_v4_matrix.py" \
...
```bash
  /home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
  /mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/v19_algebra_universal_v4/audit_v19_algebra_universal_v4_algebra.py \
