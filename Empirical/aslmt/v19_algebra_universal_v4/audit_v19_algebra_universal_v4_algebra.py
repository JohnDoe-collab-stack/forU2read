...
from aslmt_env_v19_algebra_universal_v4 import AlgebraUniversalEpisodeCfg, sample_episode
from aslmt_oracle_v19_algebra_universal_v4_common import candidate_mask, sigma_ambiguity
...
def main() -> None:
    p = argparse.ArgumentParser(description="Independent algebra audit for v19 universal v4 episodes.")
