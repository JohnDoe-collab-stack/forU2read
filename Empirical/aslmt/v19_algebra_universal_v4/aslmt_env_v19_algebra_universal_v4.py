...
from aslmt_oracle_v19_algebra_universal_v4_common import (
    HorizonOracleCfg,
    candidate_mask,
...
def sample_episode(
    *,
    ...
    if y != 2:
        raise ValueError("v19 universal v4 currently requires y_classes=2")
    if base_view != 0:
        raise ValueError("v19 universal v4 expects base_view=0")
    if v < 3:
