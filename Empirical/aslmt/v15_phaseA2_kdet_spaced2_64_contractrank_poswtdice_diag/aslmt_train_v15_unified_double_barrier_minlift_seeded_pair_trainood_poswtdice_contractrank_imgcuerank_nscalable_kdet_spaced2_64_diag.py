...
from aslmt_env_v15_unified_double_barrier_minlift_nscalable_spaced2_64 import (
...
from render_v15_unified_paired_ctx_nscalable_spaced2_64 import Ctx, POS_STRIDE, render
...
def main() -> None:
    ...
    out = {
        "kind": "aslmt_v15_unified_double_barrier_minlift_poswtdice_contractrank_imgcuerank_spaced2_64",
        "seed": int(cfg.seed),
        "n_classes": int(n_classes),
    ...
    if str(args.out_faildump_jsonl).strip():
        ...
        if need_dump:
            ...
            rec = {
                "kind": "aslmt_v15_faildump_image_gate",
                "seed": int(cfg.seed),
                "n_classes": int(n_classes),
                "z_classes": int(z_classes),
