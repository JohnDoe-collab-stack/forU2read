...
def main() -> None:
    p = argparse.ArgumentParser(description="Strict verifier for ASLMT v19 algebra universal v4.8 matrix runs.")
    ...
    expected_kind = "aslmt_v19_algebra_universal_actionz_v4_8"
    ...
    for n in n_list:
        ...
        # Do not attempt aggregation if required fields are missing: report failures cleanly.
        if incomplete:
            continue
    ...
    if failures:
        print("\n[FAIL] v19 algebra universal v4.8 checks did not pass:")
        for s in failures:
            print("-", s)
        raise SystemExit(1)

    print("\n[OK] v19 algebra universal v4.8 checks passed.")
