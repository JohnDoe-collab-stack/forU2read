...
def _zs_for_n_A2(n: int) -> list[int]:
...
def main() -> None:
    p = argparse.ArgumentParser(description="Strict verifier for ASLMT v12 clean64 Phase A2 matrix runs.")
    ...
    if failures:
        print("\n[FAIL] v12 clean64 Phase A2 matrix checks did not pass:")
        for s in failures:
            print("-", s)
        raise SystemExit(1)
    print("\n[OK] v12 clean64 Phase A2 matrix checks passed.")
