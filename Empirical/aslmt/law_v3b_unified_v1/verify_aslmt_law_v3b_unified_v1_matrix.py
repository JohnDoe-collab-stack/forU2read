...
def main() -> None:
    p = argparse.ArgumentParser(description="Strict verifier for ASLMT law_v3b_unified_v1 matrix runs.")
    ...
    if failures:
        print("\n[FAIL] law_v3b_unified_v1 matrix checks did not pass:")
        for s in failures:
            print("-", s)
        raise SystemExit(1)

    print("\n[OK] law_v3b_unified_v1 matrix checks passed.")
