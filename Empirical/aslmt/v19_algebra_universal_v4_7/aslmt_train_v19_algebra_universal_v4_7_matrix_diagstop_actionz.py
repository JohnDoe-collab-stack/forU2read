...
from aslmt_env_v19_algebra_universal_v4_7 import V19AlgebraUniversalDataset
from aslmt_model_v19_algebra_universal_v4_7_actionz import (
    V19AlgebraCueOnlyBaseline,
    V19AlgebraUniversalModelA_ActionZ,
    V19AlgebraVisibleOnlyBaseline,
)
from aslmt_oracle_v19_algebra_universal_v4_7_common import (
    HorizonOracleCfg,
    candidate_mask,
...
def main() -> None:
    p = argparse.ArgumentParser(
        description="ASLMT v19 algebra universal v4.7 trainer (learned encoder policy, horizon oracle supervision, action-as-z)."
    )
    ...
    rec = {
        "kind": "aslmt_v19_algebra_universal_actionz_v4_7",
        "seed": int(args.seed),
        "n_states": int(n_states),
        "n_views": int(n_views),
        "y_classes": int(y_classes),
