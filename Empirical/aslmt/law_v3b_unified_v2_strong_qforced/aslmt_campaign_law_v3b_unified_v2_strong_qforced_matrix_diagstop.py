...
def main() -> None:
    ...
    tag = f"aslmt_law_v3b_unified_v2_strong_qforced_{profile}_{ts}_{bundle_hash[:12]}"
    ...
    manifest = {
        "kind": "aslmt_law_v3b_unified_v2_strong_qforced_snapshot",
        "timestamp": ts,
        "profile": str(profile),
    ...
    master_jsonl = run_dir / f"law_v3b_unified_v2_strong_qforced_{profile}_master_{ts}_{bundle_hash[:12]}.jsonl"
