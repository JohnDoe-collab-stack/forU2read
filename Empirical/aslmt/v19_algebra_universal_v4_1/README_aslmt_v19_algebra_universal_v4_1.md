# ASLMT v19 — Algebra Universal v4.1 (learned encoder policy, strict protocol)

v4.1 builds on v4 and applies small correctness/documentation fixes without changing the intended protocol.
...
## Smoke (end-to-end)
  ...
  v19_algebra_universal_v4_1/aslmt_campaign_v19_algebra_universal_v4_1_matrix_diagstop_actionz.py \
...
snap_dir="/mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/runs/snapshots/<RUN_TAG>"
  /home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
  "$snap_dir/verify_aslmt_v19_algebra_universal_v4_1_matrix.py" \
...
```bash
  /home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
  /mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/v19_algebra_universal_v4_1/audit_v19_algebra_universal_v4_1_algebra.py \
