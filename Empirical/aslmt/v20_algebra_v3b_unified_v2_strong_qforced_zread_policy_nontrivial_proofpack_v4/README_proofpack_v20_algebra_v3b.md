# v20 algebra v3b — Proof Pack v4 (structural counterexamples + marginal no-go + minproof sweep)
...
/home/frederick/.venvs/cofrs-gpu/bin/python3 -u \
  /mnt/c/Users/frederick/Documents/forU2read/Empirical/aslmt/v20_algebra_v3b_unified_v2_strong_qforced_zread_policy_nontrivial_proofpack_v4/aslmt_campaign_v20_algebra_v3b_proofpack.py \
...
`Empirical/aslmt/runs/aslmt_v20_algebra_v3b_proofpack_v4_<ts>_<hash>/`

and the frozen sources under:

`Empirical/aslmt/runs/snapshots/aslmt_v20_algebra_v3b_proofpack_v4_<ts>_<hash>/`
