...
class VNMinLiftModelA(nn.Module):
    ...
    def __init__(self, *, z_classes: int, hid: int = 32):
        ...
        # image + (x,y) coordinate channels: needed to place the (h,k)-dependent
        # target inside an occluded region where image may be locally constant.
        self.img_enc = _SmallCNN(3, hid=hid)
