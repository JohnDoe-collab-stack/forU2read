...
def main() -> None:
    p = argparse.ArgumentParser(description="Strict verifier for ASLMT v13 Phase A2 matrix runs.")
    ...
    if failures:
        print("\n[FAIL] v13 Phase A2 matrix checks did not pass:")
        for s in failures:
            print("-", s)
        raise SystemExit(1)

    print("\n[OK] v13 Phase A2 matrix checks passed.")
