...
def train(args) -> dict:
    ...
    return {
        ...
        "train_ood_ratio": float(args.train_ood_ratio),
        "metrics": {
            "iid": {"A_iou": float(iid_A_iou), "B_img_iou": float(iid_Bimg_iou), "B_cue_iou": float(iid_Bcue_iou), "z_acc": float(iid_z_acc)},
            "ood": {"A_iou": float(ood_A_iou), "B_img_iou": float(ood_Bimg_iou), "B_cue_iou": float(ood_Bcue_iou), "z_acc": float(ood_z_acc)},
        },
        "pair_eval": pair_eval,
    }
