...
def main() -> None:
    p = argparse.ArgumentParser(description="Strict verifier for ASLMT v20 algebra v3b matrix runs.")
    ...
    if failures:
        print("\n[FAIL] v20 algebra v3b matrix checks did not pass:")
        for s in failures:
            print("-", s)
        raise SystemExit(1)

    print("\n[OK] v20 algebra v3b matrix checks passed.")
