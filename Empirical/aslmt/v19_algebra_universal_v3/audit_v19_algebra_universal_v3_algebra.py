...
from aslmt_env_v19_algebra_universal_v3 import AlgebraUniversalEpisodeCfg, sample_episode
from aslmt_oracle_v19_algebra_universal_v3_common import candidate_mask, sigma_ambiguity
...
def _episode_amb_trace(*, tables: torch.Tensor, sigma: torch.Tensor, x: int, actions: list[int]) -> list[int]:
    ...
    out = []
    # Record ambiguity for base only, then after each action is applied.
