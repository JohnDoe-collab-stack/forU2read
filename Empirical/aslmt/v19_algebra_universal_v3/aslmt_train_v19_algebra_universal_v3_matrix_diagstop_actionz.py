...
from aslmt_env_v19_algebra_universal_v3 import V19AlgebraUniversalDataset
from aslmt_model_v19_algebra_universal_v3_actionz import (
    V19AlgebraCueOnlyBaseline,
    V19AlgebraUniversalModelA_ActionZ,
    V19AlgebraVisibleOnlyBaseline,
)
from aslmt_oracle_v19_algebra_universal_v3_common import HorizonOracleCfg, oracle_allowed_actions
...
def main() -> None:
    p = argparse.ArgumentParser(description="ASLMT v19 algebra universal v3 trainer (horizon oracle labels, learned policy, action-as-z).")
    ...
    for step in range(1, int(steps) + 1):
        ...
        for t in range(int(max_steps)):
            ...
            # Force STOP after STOP to keep transcripts well-formed.
    ...
    rec = {
        "kind": "aslmt_v19_algebra_universal_actionz_v3",
        "seed": int(args.seed),
        "n_states": int(n_states),
        "n_views": int(n_views),
        "y_classes": int(y_classes),
